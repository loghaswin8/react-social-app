...
export const DataProvider = ({children}) => {
    ...
    return (
        <DataContext.Provider value={{
            width, search, setSearch, searchResults, isLoading, fetchError, postTitle, setPostTitle, postBody, setPostBody, handleSubmit, handleDelete, posts,  handleEdit, editBody, editTitle, setEditBody, setEditTitle
        }}>
            {children}
